...
class GooglePlusButton : SocialButton {
    override val shape: Drawable by lazy {
        ...
        shape.paint.color = Color.argb(255, 219, 68, 55)
        return@lazy shape
    }
    ...
    private fun initialize() {
        setCompoundDrawablesRelativeWithIntrinsicBounds(ActivityCompat.getDrawable(context, R.drawable.ic_google_plus), compoundDrawables[1], compoundDrawables[2], compoundDrawables[3])
    }
