...
class FacebookButton : SocialButton {
    override val shape: Drawable by lazy {
        ...
        shape.paint.color = Color.argb(255, 52, 87, 152)
        return@lazy shape
    }
    ...
    private fun initialize() {
        setCompoundDrawablesRelativeWithIntrinsicBounds(ActivityCompat.getDrawable(context, R.drawable.ic_facebook), compoundDrawables[1], compoundDrawables[2], compoundDrawables[3])
    }
